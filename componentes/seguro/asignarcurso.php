...
function archivo($val1, $val2){
    if(!empty($val1)){
        if(substr($val1, -3)=="pdf"){
            $fin = "<a href=\"archivos_seguros/".$val1."\" target=\"_blank\"><img src=\"plantillas/default/img/pdf.png\">".$val1."</a> - <a href=\"".$val2."\" class=\"eliminararch\" title=\"".$val1."\">x</a>";
        }
        else {
            $fin = "<a href=\"archivos_seguros/".$val1."\" target=\"_blank\"><img src=\"plantillas/default/img/jpg.png\">".$val1."</a> - <a href=\"".$val2."\" class=\"eliminararch\" title=\"".$val1."\">x</a>";
        }
    }
    else {
        $fin = "";
