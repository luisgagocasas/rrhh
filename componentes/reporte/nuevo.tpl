...
<div class="grid grid-pad">
    <div class="col-1-3">
        ...
        <div class="form_control">
            ...
            <input type="date" name="cumpleanios" step="1" min="1950-01-01" max="2013-12-31" id="txtfcumple">
        </div>
        <div class="form_control">
            <label for="txtffempresa">F. Empresa</label>
            <input type="date" name="fempresa" step="1" min="1950-01-01" max="2013-12-31" id="txtffempresa">
        </div>
    </div>
    <div class="col-1-3">
        <div class="form_control">
