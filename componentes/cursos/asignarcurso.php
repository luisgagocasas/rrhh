...
function archivo($val1, $val2){
    if(!empty($val1)){
        if(substr($val1, -3)=="pdf"){$fin = "<a href=\"archivos_cursos/".$val1."\" target=\"_blank\"><img src=\"plantillas/default/img/pdf.png\">".$val1."</a> - <a href=\"".$val2."\" class=\"eliminararch\" title=\"".$val1."\">x</a>"; }
        else { $fin = "<a href=\"archivos_cursos/".$val1."\" target=\"_blank\"><img src=\"plantillas/default/img/jpg.png\">".$val1."</a> - <a href=\"".$val2."\" class=\"eliminararch\" title=\"".$val1."\">x</a>"; }
    }
    else { $fin = ""; }
    return $fin;
}
function archivos($val1, $val2){
    if(!empty($val1)){
        if(substr($val1, -3)=="pdf"){ $fin = "<a href=\"archivos_cursos/".$val1."\" target=\"_blank\"><img src=\"plantillas/default/img/pdf.png\">".$val1."</a>"; }
        else { $fin = "<a href=\"archivos_cursos/".$val1."\" target=\"_blank\"><img src=\"plantillas/default/img/jpg.png\">".$val1."</a>"; }
    }
    else { $fin = ""; }
    return $fin;
}
        ...
        if($asig['id_curso']==$cont['curso_id'] and $asig['id_usuario']==$user['id']){
            $respuesta->mensaje .= '
                <div class="grid grid-pad select001">
                    ...
                    <div class="col-1-3">
                        <div style="display: inline;margin: 5px 0px 0px 0px;">
                            '.archivos($asig['archivo'], $asig['id_asig_curso']).'
                        </div>
                    </div>
                </div>';
        }
